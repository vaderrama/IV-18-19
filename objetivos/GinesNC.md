### Objetivos de Ginés Navarrete Campos
...
- [x] Revisar errores comunes en el hito 4.
    - Comprender qué es exactamente la documentación y para qué sirve.
      ...
      Sí es para:
        ...
        - No poner más que métodos GET. Para añadir información, se debe usar un método no seguro como, por ejemplo, PUT.
        - Usar métodos GET para cambiar el estado del servidor. Para ello se deben usar los llamados métodos no seguros, viz.: DELETE, PATCH, POST y PUT.
...
- [x] Reentregar el último hito corrigiendo los fallos.
